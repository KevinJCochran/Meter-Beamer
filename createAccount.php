		...
		<div class="row">
			<div class="col-md-3 col-md-offset-3">
				<div class="form-group">
		    		...
		    		<input class="form-control" id="first_name" name="first_name" style="width: 200px" placeholder="Artisanal kale">
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="form-group">
	    			...
	    			<input class="form-control" id="last_name" name="last_name" style="width: 200px" placeholder="How do I shoot web">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-3 col-md-offset-3">
				<div class="form-group">
			    	...
			    	<input class="form-control" id="address" name="address" style="width: 490px" placeholder="bootstrap@example.com">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-3 col-md-offset-3">
				<div class="form-group">
	    			...
	    			<input class="form-control" id="user_name" name="user_name" style="width: 200px" placeholder="">
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="form-group">
	    			...
	    			<input class="form-control" id="password" name="password" style="width: 200px" placeholder="bootstrap@example.com">
				</div>
			</div>
		</div>
	</div>
